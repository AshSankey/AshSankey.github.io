...
const MAXBREAKPOINT = 9999,
  ...
  skmSettings = new Map([
    ...
    [
      "flow_inheritfrom",
      ["radio", "none", ["source", "target", "outside-in", "none"]],
    ],
    ...
    [
      "layout_attachincompletesto",
      ["radio", "nearest", ["leading", "nearest", "trailing"]],
    ],
    ...
    [
      "labels_fontface",
      ["radio", "sans-serif", ["monospace", "sans-serif", "serif"]],
    ],
    ...
    [
      "labelvalue_position",
      ["radio", "below", ["above", "before", "after", "below"]],
    ],
  ...
  sourceHeaderPrefix = "// Viroet diagram inputs -",
  sourceURLLine = "// https://Viroet.com",
